...
const AppKey = '7268428d-d814-4era-8829-3dbe0e2eaa7a';

const mmkvOptions: MMKVConfiguration = {
  id: `user-${appName}-storage`,
};

if (Platform.OS !== 'web') {
  mmkvOptions.encryptionKey = AppKey;
}

const AppStorage = new MMKV(mmkvOptions);
